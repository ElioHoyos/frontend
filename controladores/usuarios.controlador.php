			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('pasteleriadiego@.com', 'Pasteleria Diegos');

					$mail->addReplyTo('pasteleriadiego@.com', 'Pasteleria Diegos');
			...
			if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["passEmail"])){
				...
				if($respuesta1){
					...
					if($respuesta2  == "ok"){
						...
						$mail->setFrom('pasteleriadiego@gmail.com', 'Pasteleria Diegos');

						$mail->addReplyTo('pasteleriadiego@gmail.com', 'Pasteleria Diegos');
